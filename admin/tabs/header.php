<div class="wrap sadran-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a href="?page=sadran-security&tab=logs" class="nav-tab <?= $tab=='logs'?'nav-tab-active':'' ?>">Logs</a>
        <a href="?page=sadran-security&tab=settings" class="nav-tab <?= $tab=='settings'?'nav-tab-active':'' ?>">Settings</a>
    </h2>
